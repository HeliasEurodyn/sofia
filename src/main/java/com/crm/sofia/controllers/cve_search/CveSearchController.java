package com.crm.sofia.controllers.cve_search;
...
import com.crm.sofia.services.cve_search.CveSearchService;
...
public class CveSearchController {
    ...
    public CveDTO getCVes(@PathVariable("cpe") String cpe) {
