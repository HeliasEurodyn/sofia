...
public class NodeGraphService {
    ...
    public Object getAsset(Long id) {
        ...
        Object relatedAssets = this.getRelatedAssets(id);
    ...
    @Transactional
    @Modifying
    public void updateAssetRelationship(Long atoaId, String relCode) {
        String queryString =
                " UPDATE asset_to_asset SET asset_relationship = :asset_relationship WHERE id = :atoa_id ";
    ...
    @Transactional
    @Modifying
    public String insertRelatedAsset(Long assetId, Long relAssetId) {
        String queryString =
    ...
    @Transactional
    @Modifying
    public void removeRelatedAsset(Long atoaId) {
        String queryString =
                " DELETE FROM asset_to_asset WHERE id = :id";
        Query query = entityManager.createNativeQuery(queryString);
    ...
    @Transactional
    @Modifying
    public void saveAssetPositions(NodeDTO dto) {
        String queryString =
                " UPDATE asset SET " +
                        "graph_top = :graph_top , " +
