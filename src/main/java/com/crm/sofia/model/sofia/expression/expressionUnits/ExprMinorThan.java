...
public class ExprMinorThan extends ExprUnit {

    static private Integer exprUnitLength = 9;
    static private String exprUnitString = "minorThan";

    public static ExprMinorThan exrtactExprUnit(String expression, Integer expressionPosition) {
        ...
        if (expressionPart.equals(exprUnitString)) {
            ExprMinorThan exprUnit = new ExprMinorThan();
