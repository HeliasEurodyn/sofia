...
public class ExprGreaterThan extends ExprUnit {

    static private Integer exprUnitLength = 11;
    static private String exprUnitString = "greaterThan";

    public static ExprGreaterThan exrtactExprUnit(String expression, Integer expressionPosition) {
        ...
        if (expressionPart.equals(exprUnitString)) {
            ExprGreaterThan exprUnit = new ExprGreaterThan();
